...
const ChartSelector = (
  ...
  return (
    <div className="relative w-full ">
      <div className="optionSelection   text-black p-4">
        <select
      ...
      <div className="flex gap-16  overflow-hidden mb-5 mx-10">
        <div className="chart-container h-[300px] flex-1  bg-white text-black  rounded-lg">
              ...
              <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
                <AreaChart key={selectedOption} data={formattedData}>
                  ...
                  <ChartTooltip
                    ...
                    content={
                      <ChartTooltipContent
                        className="  text-red-600 font-bold w-[200px] p-2"
